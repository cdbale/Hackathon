...
Currently: function calculates uniqueness for all individuals with at least the number of sampled points. Disregards original point ordering, essentially we are comparing the set of points for each individual (order doesn't matter).
```{r}
