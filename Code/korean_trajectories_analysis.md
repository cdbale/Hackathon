...
trajectory_uniqueness <- function(trajectory_data, num_points, nits = 1)
{
  ...
  return(replicate(n = nits, length(unique(lapply(split_trajectories, 
...
up_4d <- sapply(1:5, function(x) trajectory_uniqueness(trajectories_4d, num_points = x, nits = 2))
...
up_3d <- sapply(1:5, function(x) trajectory_uniqueness(trajectories_3d, num_points = x, nits = 2))
...
up_2d <- sapply(1:5, function(x) trajectory_uniqueness(trajectories_2d, num_points = x, nits = 2))
...
up_1d <- sapply(1:5, function(x) trajectory_uniqueness(trajectories_1d, num_points = x, nits = 2))
...
up_0d <- sapply(1:5, function(x) trajectory_uniqueness(trajectories_0d, num_points = x, nits = 2))
