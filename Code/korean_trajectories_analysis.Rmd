...
First, install and load necessary packages. We use the `tidyverse` package for data manipulation and visualization, and the `patchwork` package for displaying multiple plots together.
```{r message = FALSE}
